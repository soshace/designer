// source --> http://107.191.56.6/~zemsapparel/wp-content/plugins/designer/assets/js/farbtastic.js?ver=2.2.1 
/**
...
var fb = this;
// Insert markup
jQuery(container).html('<div class="farbtastic"><div class="color"></div><div class="wheel"></div><div class="overlay"></div><div class="h-marker marker"></div><div class="sl-marker marker"></div><div class="none-color"></div></div>');
...
fb.noneColorBox.tooltip({ placement: "bottom" });
// Dimensions
fb.radius = 84;
fb.square = 100;
fb.width = 200;
...
if (el && jQuery(el).attr("class") === "none-color") isNoneColor = true;
